  ...
  const addNewSection = () => {
    ...
    if (
      ...
      const newContent = {
        ...
        description: "",
        videoLength: "",
        videoSection: `Phần mới ${activeSection}`,
        links: [{ title: "", url: "" }],
      };
      setCourseContentData([...courseContentData, newContent]);
    }
            ...
            >
              ...
              {!isCollapsed[index] && (
                <>
                  ...
                  <div className="mb-3">
                    <label className={styles.label}>Thời lượng video (phút)</label>
                    <input
                      type="number"
                      placeholder="20"
                      className={`${styles.input}`}
                  ...
                  {item?.links.map((link: any, linkIndex: number) => (
                    <div className="mb-3 block" key={linkIndex}>
                      ...
                      <input
                        type="text"
                        placeholder="Source Code... (Tên link)"
                        className={`${styles.input}`}
                        value={link.title}
                        onChange={(e) => {
                          const updatedData = [...courseContentData];
                      ...
                      <input
                        type="url"
                        placeholder="Đường dẫn Source Code... (URL link)"
