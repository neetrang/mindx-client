  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">MindX?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than MindX, the premier programming community
          dedicated to helping new programmers achieve their goals and reach
          their full potential.
          <br />
          <br />
          As the founder and CEO of MindX, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created MindX &ndash; to provide new
          programmers with the resources and support they need to succeed.
          <br />
          <br />

          At MindX, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But MindX is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With MindX by your side, there&apos;s nothing standing between
          ...
          <br />
          <br />
          So what are you waiting for? Join the MindX family today and
